...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            ...
            url: "https://storage.googleapis.com/cpass-sdk/libs/iOS/public/JMMedia/dynamic/v_1_0_4/JMMediaStackSDK.xcframework.zip",
            checksum: "ccba15bbea7bcb53dd8307971e57941b9c4fee16ca89cacaace5fd80eee54c22"
        ),
        .binaryTarget(
            name: "Mediasoup",
