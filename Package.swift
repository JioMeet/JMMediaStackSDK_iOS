...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            ...
            url: "https://storage.googleapis.com/cpass-sdk/libs/iOS/public/JMMedia/dynamic/v_1_0_1_alpha_1/JMMediaStackSDK.xcframework.zip",
            checksum: "d60ca91d24db291fe7c3c5f43fa3785312d62241abed515fc11e43cea3de922a"
        ),
        .binaryTarget(
            name: "Mediasoup",
