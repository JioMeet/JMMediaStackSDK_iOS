...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            ...
            url: "https://storage.googleapis.com/cpass-sdk/libs/iOS/public/JMMedia/dynamic/v_1_0_8/JMMediaStackSDK.xcframework.zip",
            checksum: "f66aaa6143511509cfb67b5de4fe0715ffa615280cacc6b07d38a7586b396ee8"
        ),
        .binaryTarget(
            name: "Mediasoup",
