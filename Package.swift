...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            ...
            url: "https://storage.googleapis.com/cpass-sdk/libs/iOS/public/JMMedia/dynamic/1_0_8_alpha_1/JMMediaStackSDK.xcframework.zip",
            checksum: "f0351306b33917e9e6e9611bf948b7f8aadfcf4791c2ac426d6f4d092e41bb01"
        ),
        .binaryTarget(
            name: "Mediasoup",
