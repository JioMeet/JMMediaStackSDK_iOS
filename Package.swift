...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            ...
            url: "https://storage.googleapis.com/cpass-sdk/libs/iOS/public/JMMedia/dynamic/v_1_0_7/JMMediaStackSDK.xcframework.zip",
            checksum: "f0376065845d652e786b64c7abe412ac5da093d3b573b751aded2195e4488464"
        ),
        .binaryTarget(
            name: "Mediasoup",
