...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            ...
            url: "https://storage.googleapis.com/cpass-sdk/libs/iOS/public/JMMedia/dynamic/v_1_0_6/JMMediaStackSDK.xcframework.zip",
            checksum: "f49dfaf82005291bb339c02e1f64b4ba8939611de7aa2c5fa6ec51484248f4f1"
        ),
        .binaryTarget(
            name: "Mediasoup",
